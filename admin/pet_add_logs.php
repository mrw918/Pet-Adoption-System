...
$pageTitle = 'Pet Add Logs';
$adminNav = 'pet_add_logs';
...
if (pet_add_log_table_ready()) {
    $stmt = mysqli_prepare(
        $conn,
        'SELECT log_id, admin_id, pet_id, pet_name, action_status, detail_note, ip_addr, create_time
         FROM pet_add_log
    ...
    if ($stmt) {
        ...
        mysqli_stmt_bind_result($stmt, $logId, $adminId, $petId, $petName, $status, $note, $ip, $ctime);
...
<h1 class="admin-page-title">Pet Add Logs</h1>
<p class="admin-lead">Records of adding new pets.</p>
...
<div class="admin-panel">
    <div class="admin-table-wrap">
        <table class="admin-table">
            ...
            <tbody>
                <?php if ($rows === []) : ?>
                    <tr><td colspan="8">No pet-add logs yet.</td></tr>
                <?php else : ?>
